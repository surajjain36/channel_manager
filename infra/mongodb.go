...
func NewMongo(conf *misc.MongoConfig) (*MongoDB, error) {
...
func (mgo *MongoDB) Insert(collection string, data interface{}) (interface{}, error) {
	var err error
	var res interface{}
...
func (mgo *MongoDB) Aggregate(collection string, pipeline interface{}, result interface{}) error {
	var err error
